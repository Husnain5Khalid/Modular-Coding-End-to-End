...
class DataIngestionConfig:
    train_data_path:str = TRAIN_FILE_PATH # where to save train data
    test_data_path:str = TEST_FILE_PATH  # where to save test data
    raw_data_path:str = RAW_FILE_PATH   # where to save raw data
